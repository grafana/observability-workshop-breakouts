...
const config = {
  title: 'Grafana Observability Workshop Breakouts',
  tagline: 'Hands-on breakouts for Grafana Cloud Observability',
  favicon: 'img/favicon.ico',

  url: 'https://grafana.github.io/',
  baseUrl: '/observability-workshop-breakouts/',

  organizationName: 'grafana',
  projectName: 'observability-workshop-breakouts',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/grafana/observability-workshop-breakouts/tree/main/site/',
        },
        blog: false,
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            href: 'https://github.com/grafana/observability-workshop-breakouts',
            label: 'GitHub',
            position: 'right',
          },
        ],
