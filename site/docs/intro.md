...
Prefer light or dark? Toggle in the top right corner.

## What you'll need

- A modern web browser
- A URL to a Grafana Cloud instance (provided by your facilitator)
- A personal login (provided by your facilitator)
